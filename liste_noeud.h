 ...
 */
float distance_noeud_liste(const liste_noeud_t* liste, noeud_id_t destination);
 ...
 */
noeud_id_t precedent_noeud_liste(const liste_noeud_t* liste, noeud_id_t destination);
 ...
 */
void changer_noeud_liste(liste_noeud_t* liste, noeud_id_t noeud_modif, noeud_id_t noeud_prec, float distance);
